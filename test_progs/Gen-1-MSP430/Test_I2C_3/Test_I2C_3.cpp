 ...
 * This is another test program I used on the MSP430 to test the keypad functionality with
 ...
 * Here, the Real Time Clock, LCD display, and I2C bus libraries are added to the compilation
 * to check if total program size will fit in the MSP430 Flash memory (it does so far)
*/
